import{_ as e,M as i,p as l,q as t,R as n,t as s,N as c,a1 as o}from"./framework-ebd9a7c2.js";const p={},r=n("h2",{id:"mac安装nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mac安装nginx","aria-hidden":"true"},"#"),s(" Mac安装Nginx")],-1),d=n("h3",{id:"安装工具",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装工具","aria-hidden":"true"},"#"),s(" 安装工具")],-1),u={href:"https://brew.sh/index_zh-cn.html",target:"_blank",rel:"noopener noreferrer"},v=o(`<h3 id="安装步骤" tabindex="-1"><a class="header-anchor" href="#安装步骤" aria-hidden="true">#</a> 安装步骤</h3><ul><li>安装 <code>homebrew</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>/usr/bin/ruby <span class="token parameter variable">-e</span> <span class="token string">&quot;<span class="token variable"><span class="token variable">$(</span><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://raw.githubusercontent.com/Homebrew/install/master/install<span class="token variable">)</span></span>&quot;</span>
