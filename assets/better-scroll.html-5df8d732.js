import{_ as n,p as s,q as a,a1 as t}from"./framework-1c630d00.js";const p={},e=t(`<h2 id="better-scroll-封装" tabindex="-1"><a class="header-anchor" href="#better-scroll-封装" aria-hidden="true">#</a> better-scroll 封装</h2><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> better-scroll <span class="token parameter variable">--save</span>
