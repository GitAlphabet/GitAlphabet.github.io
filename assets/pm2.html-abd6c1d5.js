import{_ as a,p as s,q as n,a1 as e}from"./framework-5866ffd3.js";const p={},t=e(`<h3 id="pm2" tabindex="-1"><a class="header-anchor" href="#pm2" aria-hidden="true">#</a> pm2</h3><p>让 Node 服务在退出 ssh 客户端后继续运行服务。</p><h4 id="安装及使用" tabindex="-1"><a class="header-anchor" href="#安装及使用" aria-hidden="true">#</a> 安装及使用</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> pm2 <span class="token parameter variable">-g</span>     <span class="token comment"># 命令行安装 pm2</span>
