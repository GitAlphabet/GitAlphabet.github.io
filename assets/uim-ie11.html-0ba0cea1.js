import{_ as n,p as s,q as a,a1 as e}from"./framework-347dbdeb.js";const t={},p=e(`<h2 id="umi兼容ie11" tabindex="-1"><a class="header-anchor" href="#umi兼容ie11" aria-hidden="true">#</a> umi兼容IE11</h2><h3 id="修改config-js" tabindex="-1"><a class="header-anchor" href="#修改config-js" aria-hidden="true">#</a> 修改config.js</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
