import{_ as s,p as a,q as n,a1 as e}from"./framework-5866ffd3.js";const l={},i=e(`<h3 id="安装问题" tabindex="-1"><a class="header-anchor" href="#安装问题" aria-hidden="true">#</a> 安装问题</h3><h4 id="_1、刚安装的mysql无法启动-提示没有权限" tabindex="-1"><a class="header-anchor" href="#_1、刚安装的mysql无法启动-提示没有权限" aria-hidden="true">#</a> 1、刚安装的mysql无法启动，提示没有权限</h4><p><strong>The innodb_system data file &#39;ibdata1&#39; must be writable</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>2021-11-25T05:52:43.397230Z 1 <span class="token url">[<span class="token content">ERROR</span>] [<span class="token variable">MY-012271</span>]</span> [InnoDB] The innodb_system data file &#39;ibdata1&#39; must be writable
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、版本-8-x-修改密码" tabindex="-1"><a class="header-anchor" href="#_2、版本-8-x-修改密码" aria-hidden="true">#</a> 2、版本 8.x 修改密码</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mysql <span class="token parameter variable">-u</span> root <span class="token parameter variable">-p</span>
