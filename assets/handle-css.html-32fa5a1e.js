import{_ as s,p as n,q as a,a1 as e}from"./framework-1c630d00.js";const p={},t=e(`<h2 id="处理-css-less-sass" tabindex="-1"><a class="header-anchor" href="#处理-css-less-sass" aria-hidden="true">#</a> 处理 css/less/sass</h2><h3 id="安装loader" tabindex="-1"><a class="header-anchor" href="#安装loader" aria-hidden="true">#</a> 安装loader</h3><p><strong>style-loader、css-loader、postcss-loader</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i style-loader css-loader postcss-loader --save-dev
