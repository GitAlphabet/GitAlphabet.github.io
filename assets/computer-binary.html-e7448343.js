import{_ as e,p as a,q as d,a1 as n}from"./framework-69837a10.js";const i={},s=n(`<h2 id="原码、补码、反码" tabindex="-1"><a class="header-anchor" href="#原码、补码、反码" aria-hidden="true">#</a> 原码、补码、反码</h2><h3 id="机器数和真值" tabindex="-1"><a class="header-anchor" href="#机器数和真值" aria-hidden="true">#</a> 机器数和真值</h3><p>1、机器数:一个数在计算机中的二进制表示形式, 叫做这个数的机器数。机器数是带符号的，在计算机用一个数的最高位存放符号, 正数为0, 负数为1.</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>+1 &gt;&gt;&gt;&gt;&gt; 0000 0001
-1 &gt;&gt;&gt;&gt;&gt; 1000 0001
