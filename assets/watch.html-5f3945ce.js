import{_ as n,p as a,q as s,a1 as e}from"./framework-cd67069b.js";const t={},p=e(`<h2 id="watch-注意点" tabindex="-1"><a class="header-anchor" href="#watch-注意点" aria-hidden="true">#</a> watch 注意点</h2><h3 id="监听方式" tabindex="-1"><a class="header-anchor" href="#监听方式" aria-hidden="true">#</a> 监听方式</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 监听对象需要深度监听（数组不需要）</span>
