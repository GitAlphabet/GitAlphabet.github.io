import{_ as s,p as a,q as n,a1 as e}from"./framework-6d31a2a3.js";const l={},i=e(`<h2 id="安装问题" tabindex="-1"><a class="header-anchor" href="#安装问题" aria-hidden="true">#</a> 安装问题</h2><h3 id="权限问题" tabindex="-1"><a class="header-anchor" href="#权限问题" aria-hidden="true">#</a> 权限问题</h3><p><strong>刚安装的mysql无法启动，提示没有权限</strong><strong>The innodb_system data file &#39;ibdata1&#39; must be writable</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>2021-11-25T05:52:43.397230Z 1 <span class="token url">[<span class="token content">ERROR</span>] [<span class="token variable">MY-012271</span>]</span> [InnoDB] The innodb_system data file &#39;ibdata1&#39; must be writable
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),t=[i];function r(c,d){return a(),n("div",null,t)}const p=s(l,[["render",r],["__file","mysql-faq.html.vue"]]);export{p as default};
