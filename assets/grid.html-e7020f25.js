import{_ as n,p as s,q as a,a1 as e}from"./framework-5866ffd3.js";const p="/assets/grid1-e3502446.png",t="/assets/grid2-b7a7a3ac.png",i={},c=e('<h3 id="grid" tabindex="-1"><a class="header-anchor" href="#grid" aria-hidden="true">#</a> Grid</h3><h4 id="_1、介绍" tabindex="-1"><a class="header-anchor" href="#_1、介绍" aria-hidden="true">#</a> 1、介绍</h4><p>CSS Gird布局也叫二维网格布局系统，可用于布局页面主要的区域布局或小型组件。网格是一组相交的水平线和垂直线，它定义了网格的列和行。我们可以指定将网格元素放置在与这些行和列相关的位置上。</p><h4 id="_2、一维布局-和-二维布局" tabindex="-1"><a class="header-anchor" href="#_2、一维布局-和-二维布局" aria-hidden="true">#</a> 2、一维布局 和 二维布局</h4><p>像流布局和Flex布局，他们都是一维布局。一维布局一次只能处理一个维度上的元素布局，一行或者一列。回想一下，流布局和Flex布局的兄弟节点，是不是都是按照行或者列来显示的。</p><p>而<strong>网格布局是二维布局，可以同时处理行和列上的布局</strong>。使用网格布局，兄弟节点可以被指定布局到网格的某个位置。 所以，网格布局相对流布局Flex布局更加的灵活。</p><p>下图就是展示了一维布局和二维布局的不同。可以看出，如果布局复杂，一维布局需要增加节点来解决；而二维布局，则不需要，这也是网格布局强大而复杂的原因。</p><p><img src="'+p+`" alt="&quot;grid布局&quot;" title="grid布局"></p><h4 id="_3、概念" tabindex="-1"><a class="header-anchor" href="#_3、概念" aria-hidden="true">#</a> 3、概念</h4><p>父元素</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5、网格单元和网格间距" tabindex="-1"><a class="header-anchor" href="#_5、网格单元和网格间距" aria-hidden="true">#</a> 5、网格单元和网格间距</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6、网格项目重叠" tabindex="-1"><a class="header-anchor" href="#_6、网格项目重叠" aria-hidden="true">#</a> 6、网格项目重叠</h4><p>上面讲到，每一个网格项目都可以指定占据的网格单元。如果多个网格项目占据同一个网格单元，按照先后顺序，默认情况是后面的DOM节点盖住前面的DOM节点。不过我们可以通过设置z-index来改变覆盖顺序。</p><h4 id="_7、元素的对齐" tabindex="-1"><a class="header-anchor" href="#_7、元素的对齐" aria-hidden="true">#</a> 7、元素的对齐</h4><p>Grid布局有以下容器属性用于对齐：</p><p><code>justify-content</code>，<code>justify-item</code>，<code>align-content</code>，<code>align-item</code></p><p>另外，Grid还增加了<code>place-content</code>和 <code>place-item</code>用于缩写。</p><p>子元素对齐属性：<code>justify-self</code>，<code>align-self</code>，<code>place-self</code>。</p><ul><li><code>justify</code>是在垂直方向对齐方式</li><li><code>align</code>是水平方向对齐对齐</li><li><code>place</code>是前面两个属性的缩写，先<code>align</code>再<code>justify</code></li><li><code>content</code>是容器子元素的对齐</li><li><code>item</code>是子元素所在自己空间的对齐</li><li><code>self</code>是子元素的属性，用于覆盖父容器对应的<code>item</code>样式</li></ul>`,26),o=[c];function l(d,r){return s(),a("div",null,o)}const m=n(i,[["render",l],["__file","grid.html.vue"]]);export{m as default};
