import{_ as n,p as s,q as a,a1 as t}from"./framework-cd67069b.js";const e="/assets/buju-d5c10f3c.png",p={},c=t('<h2 id="布局" tabindex="-1"><a class="header-anchor" href="#布局" aria-hidden="true">#</a> 布局</h2><h3 id="实现下列布局" tabindex="-1"><a class="header-anchor" href="#实现下列布局" aria-hidden="true">#</a> 实现下列布局</h3><p>Header 定高， Main 充满其他区域</p><p><img src="'+e+`" alt="&quot;移动布局&quot;" title="移动布局示例"></p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">html,
body,
