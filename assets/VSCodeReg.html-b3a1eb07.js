import{_ as n,p as s,q as a,a1 as e}from"./framework-cd67069b.js";const t={},p=e(`<h2 id="vscode-正则替换" tabindex="-1"><a class="header-anchor" href="#vscode-正则替换" aria-hidden="true">#</a> VSCode 正则替换</h2><h3 id="末尾需要加分号" tabindex="-1"><a class="header-anchor" href="#末尾需要加分号" aria-hidden="true">#</a> 末尾需要加分号</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">{</span>
