import{_ as n,p as s,q as a,a1 as e}from"./framework-94826b74.js";const t={},p=e(`<h2 id="type和interface" tabindex="-1"><a class="header-anchor" href="#type和interface" aria-hidden="true">#</a> type和interface</h2><h3 id="相同点" tabindex="-1"><a class="header-anchor" href="#相同点" aria-hidden="true">#</a> 相同点</h3><ul><li><strong>都可以描述一个对象或者函数</strong></li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// interface</span>
